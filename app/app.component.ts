...
export class AppComponent {
   ...
   constructor() {
     this.todos = [
       new Todo("My Todo Item 1", "My Todo 1 Description", "Eunice"),
       new Todo("My Todo Item 2", "My Todo 2 Description", "Eunice"),
       new Todo("My Todo Item 3", "My Todo 3 Description", "Eunice")
     ];
   }
}